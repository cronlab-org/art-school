    ...
    <footer className="bg-[#0a0a0a] text-gray-300 mt-16">
      <div className="container mx-auto px-8 py-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-400 max-w-md">
                Inspiring creativity and fostering artistic excellence through dedicated mentorship and innovative teaching methods.
              </p>
            </div>
          ...
          <div className="w-full h-full min-h-64">
            <div className="flex justify-between items-center mb-4">
              ...
              <a 
                ...
                className="bg-white text-gray-900 px-4 py-2 rounded-md text-sm font-medium flex items-center hover:bg-gray-100 transition-colors"
              >
        ...
        <div className="border-t border-gray-800 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500">&copy; {new Date().getFullYear()} Arcus. All rights reserved.</p>
